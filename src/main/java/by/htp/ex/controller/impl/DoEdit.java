...
public class DoEdit implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			News newsEdit = new News(idEditNews, titleEditNews, dateEditNews, briefEditNews, contentEditNews);
			String check = "";
			if (titleEditNews.equals(check) || dateEditNews.equals(check) || briefEditNews.equals(check)
					|| contentEditNews.equals(check)) {
